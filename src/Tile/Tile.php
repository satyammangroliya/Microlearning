...
class Tile extends ActiveRecord
{
    ...
    const DEFAULT_LABEL_HORIZONTAL_ALIGN = self::HORIZONTAL_ALIGN_CENTER;
    ...
    const DEFAULT_OBJECT_ICON_POSITION = Tile::POSITION_NONE;
    const DEFAULT_OPEN_OBJ_WITH_ONE_CHILD_DIRECT = Tile::OPEN_TRUE;
    const DEFAULT_RECOMMENDATION_MAIL_TEMPLATE_TYPE = Tile::MAIL_TEMPLATE_SET;
    const DEFAULT_SHADOW = Tile::SHOW_TRUE;
    const DEFAULT_SHOW_ACTIONS = Tile::SHOW_ACTIONS_NONE;
    ...
    const DEFAULT_SHOW_LIKES_COUNT = Tile::SHOW_TRUE;
    ...
    const DEFAULT_VIEW = Tile::VIEW_DISABLED;//const DEFAULT_VIEW = Tile::VIEW_TILE;
...
/**
    ...
    */
     ...
     * @con_is_notnull  true
     */
    protected $show_phone = self::SHOW_PHONE;
     ...
     * @con_is_notnull  true
     */
    protected $show_tablet = self::SHOW_TABLET;
     ...
     * @con_is_notnull  true
     */
    protected $show_laptop = self::SHOW_LAPTOP;
 ...
 // customized: 
     ...
     * @return int
     */
    public function getShowPhone() : int
    {
     ...
     * @param int $status
     */
    public function setShowPhone(int $status)/*: void*/
    {
        $this->show_phone = $status;
    }
     ...
     * @return int
     */
    public function getShowTablet() : int
    {
        return $this->show_tablet;
    }

    /**
     * @param int $status
     */
    public function setShowTablet(int $status)/*: void*/
    {
        $this->show_tablet = $status;
    }
     ...
     * @return int
     */
    public function getShowLaptop() : int
    {
        return $this->show_laptop;
    }
     ...
     * @param int $status
     */
    public function setShowLaptop(int $status)/*: void*/
    {
        $this->show_laptop = $status;
    }
